...
?>
                                ...
                                <div class="card text-bg-dark mb-3">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <button id="btnNewOwner" type="button"  class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createOwnerModal"><i class="bx bx-plus"></i> <span>Propietario</span></button>    
                                        </div>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Body-->
                                        ...
                                        <div class="container caja">
                                            <div class="row">
                                                ...
                                                <div class="table-responsive">        
                                                    <table id="ownerTable" class="table table-dark table-striped" style="width:100%" >
    ...
    <script src="resources/owner/owner.js"></script>
